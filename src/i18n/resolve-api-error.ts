...
const ERROR_CODE_TO_KEY: Record<string, string> = {
  ...
  FAMILY_LINK_USE_DEDICATED_ENDPOINT: "errors.familyLinkUseDedicatedEndpoint",
  FAMILY_SOURCE_NOT_ELIGIBLE: "errors.familySourceNotEligible",
  FAMILY_TARGET_NOT_FOUND: "errors.familyTargetNotFound",
  FAMILY_TARGET_NOT_ELIGIBLE: "errors.familyTargetNotEligible",
  FAMILY_SELF_LINK_NOT_ALLOWED: "errors.familySelfLinkNotAllowed",
  FAMILY_HOUSEHOLD_CONFLICT: "errors.familyHouseholdConflict",
  FAMILY_RELATIONSHIP_CONFLICT: "errors.familyRelationshipConflict",
  FAMILY_INVALID_HOUSEHOLD_STATE: "errors.familyInvalidHouseholdState",
  FAMILY_PROTECTED_MATCH_AMBIGUOUS: "errors.familyProtectedMatchAmbiguous",
  FAMILY_LINK_ALREADY_EXISTS: "errors.familyLinkAlreadyExists",
  FAMILY_LINK_APPROVAL_REQUIRED: "errors.familyLinkApprovalRequired",
  FAMILY_DUPLICATE_PENDING: "errors.familyDuplicatePending",
  FAMILY_INVALID_RELATIONSHIP: "errors.familyInvalidRelationship",
  FAMILY_MANAGEMENT_USE_DEDICATED_ENDPOINT: "errors.familyManagementUseDedicatedEndpoint",
  FAMILY_TARGET_NOT_IN_HOUSEHOLD: "errors.familyTargetNotInHousehold",
  FAMILY_APPROVAL_STALE: "errors.familyApprovalStale",
  FAMILY_COMPANY_MEMBER_EDIT_FORBIDDEN: "errors.familyCompanyMemberEditForbidden",
  ...
  CUSTOMER_ALREADY_PRIORITY: "errors.customerAlreadyPriority",
  CUSTOMER_NOT_PRIORITY: "errors.customerNotPriority",
  CUSTOMER_ON_HOLD_REQUIRES_PRIORITY: "errors.customerOnHoldRequiresPriority",
  PRIORITY_APPROVAL_ALREADY_PENDING: "errors.priorityApprovalAlreadyPending",
  PRIORITY_APPROVAL_STALE: "errors.priorityApprovalStale",
  INVALID_PRIORITY_ACTION: "errors.invalidPriorityAction",
  PRIORITY_USE_DEDICATED_ENDPOINT: "errors.priorityUseDedicatedEndpoint",
