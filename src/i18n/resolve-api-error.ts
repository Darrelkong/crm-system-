...
const ERROR_CODE_TO_KEY: Record<string, string> = {
  ...
  RANDOM_CLAIM_BODY_NOT_ALLOWED: "errors.randomClaimBodyNotAllowed",
  INVALID_REQUEST_BODY: "errors.invalidRequestBody",
  RANDOM_CLAIM_STAFF_ONLY: "errors.randomClaimStaffOnly",
  CLAIM_METHOD_NOT_ALLOWED: "errors.claimMethodNotAllowed",
  PUBLIC_POOL_NO_ELIGIBLE_CUSTOMER: "errors.publicPoolNoEligibleCustomer",
  PUBLIC_POOL_CANDIDATE_SCAN_LIMIT: "errors.publicPoolCandidateScanLimit",
  PUBLIC_POOL_RANDOM_CLAIM_CONFLICT: "errors.publicPoolRandomClaimConflict",
...
const FIELD_CODE_TO_KEY: Record<string, string> = {
  ...
  REQUESTED_PROJECT_CODE_REQUIRED: "errors.requestedProjectCodeRequired",
  INVALID_REQUESTED_PROJECT_CODE: "errors.invalidRequestedProjectCode",
  INVALID_REQUESTED_PROJECT_OTHER_NAME: "errors.invalidRequestedProjectOtherName",
  ...
  INVALID_GENDER: "errors.invalidGender",
  INVALID_AGE_RANGE: "errors.invalidAgeRange",
  INVALID_PREFERRED_LANGUAGE: "errors.invalidPreferredLanguage",
  INVALID_PREFERRED_CONTACT_METHOD: "errors.invalidPreferredContactMethod",
  PREFERRED_NAME_TOO_LONG: "errors.preferredNameTooLong",
  OCCUPATION_TOO_LONG: "errors.occupationTooLong",
  COMPANY_NAME_TOO_LONG: "errors.companyNameTooLong",
  JOB_TITLE_TOO_LONG: "errors.jobTitleTooLong",
  TARGET_COUNTRY_OR_REGION_TOO_LONG: "errors.targetCountryOrRegionTooLong",
  PRIMARY_CONCERN_TOO_LONG: "errors.primaryConcernTooLong",
