  ...
  mail: {
    ...
    compose: {
      ...
      attachment: {
        ...
        fileTooLarge: "File exceeds the maximum size (25 MB)",
        totalSizeExceeded: "Total attachment size would exceed 25 MB",
        tooMany: "Maximum number of attachments reached",
