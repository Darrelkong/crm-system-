const en = {
  ...
  placeholders: {
    ...
    reportsDescription: "Analytics and reports are available on your dashboard.",
    reportsEmpty: "Dedicated reports are coming soon. Use the dashboard for current metrics.",
