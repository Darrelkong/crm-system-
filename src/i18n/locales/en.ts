const en = {
  ...
  mail: {
    ...
    search: {
      ...
      loadedListPlaceholder: "Search loaded messages",
    },
    list: {
      empty: "No messages in this folder",
      searchEmpty: "No loaded messages match your search",
      loadMore: "Load more",
      showMessageList: "Show message list",
      messageCount: "{{count}} messages",
      sort: "Sort",
      sortPlaceholder: "Sorting will be available in a future release",
    ...
    folders: {
      ...
      sent: "Sent",
      trash: "Trash",
      pendingMyApproval: "Awaiting my approval",
    },
    folderSheet: {
      title: "Mail folders",
      mailSection: "Mail",
      adminSection: "Workflow",
    ...
    compose: {
      ...
      dropAttachments: "Drop files here (prototype — mock only)",
      addMockAttachments: "Add mock attachments",
      send: "Send",
      submitApproval: "Submit for approval",
      queuedToOutbox: "Email added to Outbox",
      body: "Body",
      ...
      saving: "Saving…",
      savedAt: "Saved {{time}}",
      expand: "Expand compose",
      restore: "Restore compose",
      noFromAvailable: "No authorized sender available",
      loadingFrom: "Loading sender…",
      loadingDraft: "Loading draft…",
      noSignature: "No signature configured",
      attachments: "Attachments",
      ...
      attachment: {
        ...
        draftSaveFailed:
          "Draft could not be saved. Attachment upload cannot start.",
        draftNotSavedDetail:
          "The draft has not been saved yet, so the attachment cannot be uploaded.",
      ...
      seedDraftUnavailable:
        "Unable to create a reply draft. The message may no longer be available.",
      seedDraftFailed: "Unable to create a draft. Please try again.",
      seedingDraft: "Creating draft…",
      submittingApproval: "Submitting for approval…",
      submittingSend: "Sending…",
      resubmitApproval: "Resubmit for approval",
      pendingApprovalHint: "Waiting for reviewer approval",
      approvedHint: "Approved — queued for future sending",
      waitingToSend: "Waiting to send",
      sendingQueued: "Sending in progress",
      sentQueued: "Accepted by mail transport",
      deliveredQueued: "Delivered to recipient mail server",
      deliveryDeferred: "Delivery deferred by recipient server",
    ...
    sensitivity: {
      ...
      attachmentHint:
        "This message may contain sensitive attachments. Please verify recipients.",
    },
    delivery: {
      sending: "Sending",
      sent: "Sent",
      ...
      deliveredDetail: "Accepted by recipient mail server",
    },
    association: {
      link: "Link CRM customer",
      remove: "Remove link",
      badge: "CRM customer · {{name}}",
      searchPlaceholder: "Search customers…",
      noResults: "No matching customers",
      noCustomerEmail: "This customer has no email on file",
    },
    crmContext: {
      title: "CRM Context",
      customer: "Customer",
      ...
      associationAutoMatch: "Auto matched",
      empty: "No customer associated with this email.",
      notAvailable: "—",
    },
    mailboxes: {
      title: "Mailboxes",
      refresh: "Refresh",
      refreshed: "Mailbox refreshed",
      noAccessible: {
        title: "No mailbox assigned",
        description:
          "Mail access is enabled, but no mailbox has been assigned to your account yet. Please contact an administrator.",
      },
    },
    sidebar: {
      title: "Mailbox",
      ...
      collapse: "Collapse mailbox sidebar",
      expand: "Expand mailbox sidebar",
    },
    settings: {
      title: "Mail settings",
      display: "Display & layout",
      composePrefs: "Compose preferences",
      notifications: "Notifications",
      signature: "Signature",
      defaultSender: "Default sender",
      personalSection: "Personal",
      administrationSection: "Administration",
      admin: "Mail administration",
      back: "Back",
    ...
    adminCenter: {
      ...
      sections: {
        overview: "Overview",
        access: "Mail access",
        notificationIdentity: "Notification identities",
        proofDiagnostics: "Proof diagnostics",
        senderIdentity: "Sender identities",
      ...
      overview: {
        ...
        name: "Name",
        email: "Email",
        mailAccessTitle: "Mail access",
        mailAccess: "Status",
        mailAccessEnabled: "Enabled",
        mailAccessDisabled: "Disabled",
        mailAccessSystem: "Enabled (system administrator)",
        role: "Role",
        rootAdminRole: "System administrator",
        ...
        notificationIdentityNone: "No notification identity configured",
        notificationIdentityConfigureHint: "Configure notification email",
        notificationIdentityEmail: "Notification email",
        notificationIdentityStatusLabel: "Status",
        notificationIdentityVerifiedAt: "Verified at",
        retry: "Retry",
        sendingDomainTitle: "Notification sending domain",
        sendingDomainHint:
          "Cloudflare Email Sending domain for CRM notification transport only.",
        sendingDomain: "Domain",
        sendingDomainStatus: "Status",
        sendingDomainConfigured: "Configured",
        sendingFromAddress: "Default From address",
        sendingFromDisplayName: "Default From display name",
      },
      access: {
        refresh: "Refresh",
        empty: "No users found.",
        noPermission: "You do not have permission to manage mail access.",
        enable: "Enable mail access",
        disable: "Disable mail access",
        enableSuccess: "Mail access enabled.",
      ...
      notificationIdentity: {
        ...
        addEmailLabel: "Notification email",
        addEmailPlaceholder: "name@example.com",
        addAction: "Add notification email",
        ...
        issueToken: "Issue proof verification token",
        tokenModalTitle: "Proof verification token",
        tokenModalHint:
          "Copy this proof token now. It will not be shown again after you close this dialog.",
        tokenExpiresAt: "Expires {{date}}",
        copyToken: "Copy token",
        tokenCopied: "Copied",
        verifiedStateMessage:
          "Your notification email is verified and ready for CRM notifications.",
        revokedStateMessage:
          "This notification identity was revoked. Add a new notification email to continue.",
        bouncedStateMessage:
          "There is a delivery issue with this notification email. Contact your administrator if notifications fail.",
        ...
        status: {
          ...
          verified: "Notification email verified",
          revoked: "Identity revoked",
          bounced: "Delivery issue",
        },
      },
      senderIdentity: {
        refresh: "Refresh",
        empty: "No sender identities configured yet.",
        noPermission: "You do not have permission to manage sender identities.",
        systemSenderHint:
          "System notification transport (notifications@send.echfronthk.com) is managed separately and is not shown here.",
        createTitle: "Create sender identity",
        createAction: "Create sender identity",
        createSuccess: "Sender identity created.",
        enable: "Enable",
        disable: "Disable",
        enableSuccess: "Sender identity enabled.",
        disableSuccess: "Sender identity disabled.",
        setDefault: "Set as default",
        setDefaultSuccess: "Default sender updated.",
        defaultSender: "Default sender",
        ...
        mailboxLabel: "Default mailbox",
        mailboxPlaceholder: "Select an active mailbox",
        mailboxHelper:
          "The default mailbox only routes this sender identity. Sending still requires a sender identity grant and mailbox send authorization.",
        grantSelfOnCreateLabel: "Authorize me to use this identity",
        ...
        grants: {
          manageAction: "Manage grants",
          title: "Manage sender authorization",
          authorizedUsersTitle: "Authorized users",
          authorizedUserCount: "Authorized users: {{count}}",
          empty: "No authorized users yet.",
          addTitle: "Add authorization",
          addAction: "Add authorization",
          grantSuccess: "Sender authorization granted.",
          revokeSuccess: "Sender authorization revoked.",
          revokeAction: "Revoke authorization",
          userSearchLabel: "Search users",
          userSearchPlaceholder: "Search by name or email",
          userSelectLabel: "Team member",
          userSelectPlaceholder: "Select a team member",
          canSendLabel: "Send",
          canReplyLabel: "Reply",
          sendStatusAuthorized: "Send: authorized",
          sendStatusUnauthorized: "Send: not authorized",
          replyStatusAuthorized: "Reply: authorized",
          replyStatusUnauthorized: "Reply: not authorized",
          mailboxSendCapable: "Mailbox: can send",
          mailboxSendNotCapable: "Mailbox: cannot send",
          staffRole: "Staff",
          ...
          missingMailboxReplyAuthorization:
            "This user does not have reply authorization on this mailbox.",
          userMissingMailboxSendAuthorization:
            "{{name}} does not have send authorization on this personal mailbox.",
          mailboxSendAuthorized: "Mailbox send authorized",
          permissionRequired: "Select send and/or reply authorization.",
      ...
      mailbox: {
        refresh: "Refresh",
        empty: "No mailboxes configured yet.",
        noPermission: "You do not have permission to manage mailboxes.",
        systemDomainHint:
          "System notification transport on send.echfronthk.com is managed separately and is not shown here.",
        createTitle: "Create mailbox",
        createAction: "Create mailbox",
        createSuccess: "Mailbox created.",
        enable: "Enable",
        disable: "Disable",
        enableSuccess: "Mailbox enabled.",
        disableSuccess: "Mailbox disabled.",
      ...
      permission: {
        refresh: "Refresh",
        empty: "No users found.",
        noPermission: "You do not have permission to manage Mail admin grants.",
        manageAction: "Manage",
        detailTitle: "Permission management",
        currentGrantsTitle: "Current admin grants",
        addGrantTitle: "Add admin grant",
        grantAction: "Grant",
        revokeAction: "Revoke",
        grantSuccess: "Admin grant added.",
        revokeSuccess: "Admin grant revoked.",
        permissionDenied: "You do not have permission to manage Mail admin grants.",
        conflictError: "This grant already exists or cannot be revoked. Refresh and try again.",
        genericError: "Could not update admin grants. Please try again.",
        noGrants: "No delegated grants",
        grantCount: "{{count}} delegated grant(s)",
        detailNoGrants: "This user has no delegated Mail admin grants yet.",
        grantedAt: "Granted {{date}}",
        crmRoleAdmin: "CRM admin",
        crmRoleStaff: "CRM staff",
        inheritedAuthority: "Inherited authority",
        inheritedAuthorityTitle: "Inherited Mail admin authority",
        inheritedAuthorityDescription:
          "This user is a CRM root administrator and already has full Mail control-plane authority. Delegated grants are not required.",
        inheritedExplicitGrantsNote:
          "This account also has {{count}} explicit grant record(s), which do not change inherited authority.",
        rootAdminGrantHint:
          "Root administrators do not need delegated grants. Assign Mail admin grants to CRM staff accounts.",
        grants: {
          super_admin: "Mail super admin",
          permission_mgmt: "Permission management",
          account_mgmt: "Mailbox account management",
          address_assignment: "Address assignment",
          signature_template: "Signature template management",
          approval_review: "Outbound approval review",
          delivery_health: "Delivery health management",
          global_mail_read: "Global mail read",
      ...
      sharedMailbox: {
        refresh: "Refresh",
        empty: "No shared mailboxes configured yet.",
        noPermission: "You do not have permission to manage shared mailboxes.",
        systemDomainHint:
          "System notification transport on send.echfronthk.com and personal mailboxes are not managed here.",
        detailTitle: "Shared mailbox",
        manageMembers: "Manage members",
        membersTitle: "Members",
        membersEmpty: "No members assigned yet.",
        ...
        saveMember: "Save permissions",
        updateMemberSuccess: "Member permissions updated.",
        memberCount: "{{count}} members",
        memberUserLabel: "User",
        memberUserPlaceholder: "Select a user",
        memberRoleLabel: "Role preset",
        columns: {
          address: "Mailbox address",
          displayName: "Display name",
          memberCount: "Members",
        ...
        permissions: {
          ...
          canSend: "Send",
          canAssign: "Assign",
          canManageProcessing: "Manage processing",
          canAddInternalNote: "Add internal notes",
        },
      },
      signature: {
        refresh: "Refresh",
        ...
        createAction: "Create signature",
        createSuccess: "Signature version created.",
        updateSuccess: "New signature version saved.",
        setDefault: "Set as default",
        setDefaultSuccess: "Default signature updated.",
        edit: "Edit",
        defaultSignature: "Default",
        notDefault: "Not default",
        ownerLabel: "Owner",
        senderIdentityLabel: "Sender identity",
        editorCreateTitle: "New signature",
        editorEditTitle: "Edit signature",
        editorHint:
          "Changes are saved as a new version. The backend sanitizes HTML on save.",
        plainTextLabel: "Plain text",
        plainTextPlaceholder: "Fallback plain-text signature",
        htmlLabel: "HTML",
        htmlPlaceholder: "<p>Your signature HTML</p>",
        htmlHint:
          "Inline images in HTML are not supported. Logo assets require pre-uploaded stored files.",
        previewTitle: "Preview",
        previewEmpty: "Enter plain text or HTML to preview the signature.",
        previewDisclaimer:
          "Preview shows unsanitized draft content. Saved signatures are sanitized by the server.",
      ...
      approval: {
        refresh: "Refresh",
        empty: "No approval submissions found.",
        noPermission: "Mail access is required to view approval workflow.",
        scopeLabel: "View",
        scopeReviewer: "Review queue",
        scopeAuthor: "My submissions",
        statusFilterLabel: "Status",
        ...
        statusSummary: {
          ...
          sent: "Sent",
          failed: "Send failed",
          uncertain: "Send status pending confirmation",
        },
        ...
        workspaceHint:
          "Review pending outbound mail in the Mail workspace. Open the Pending review folder to read the full message before approving.",
        openWorkspace: "Go to pending review",
        pendingSummary: "{{count}} pending review(s)",
        columns: {
          sender: "Sender",
    ...
    recipient: {
      ...
      duplicate: "Recipient already added",
      remove: "Remove recipient",
      crmMatch: "Matched CRM customer: {{name}}",
      crmMismatch: "CRM registered email: {{registered}}",
      limitReached: "Maximum 50 recipients per message",
      subjectRequired: "Please enter a subject",
      noAccessibleCrmMatch: "No CRM customer match within your access",
      multipleCrmMatches: "Multiple possible CRM customers found",
      edit: "Edit",
      sourceCustomer: "CRM Customer",
      sourceContact: "Contact",
      sourceTeam: "Team Member",
      sourceShared: "Shared Mailbox",
    },
    signature: {
      locked: "Fixed Signature",
      mockLogo: "Mock Company Logo",
    },
    attachment: {
    ...
    assignment: {
      ...
      assignedToOther: "Taken by {{name}}",
      claim: "Take over",
    },
    shared: {
      handling: "Team handling",
      unclaimedHint: "Not yet claimed by anyone",
      handledBy: "{{name}} · {{status}}",
      claim: "Claim",
      transfer: "Transfer",
      statusLabel: "Status",
      readOnlyHint: "You currently have read-only access",
      internalNotes: "Internal notes",
      internalNotesHint: "Team only — never sent to external recipients",
      notePlaceholder: "Add an internal note…",
      addNote: "Add note",
      activity: "Activity",
      replyGuard: "This message is currently handled by {{name}}",
      replyAnyway: "Reply anyway",
      mentionNotifications: "Mention notifications",
      mentionNotification:
        "{{author}} mentioned you in {{mailbox}}: {{subject}}",
      debugPermission: "Shared mailbox permission (QA)",
      filter: {
        all: "All",
        unclaimed: "Unclaimed",
        mine: "Mine",
      ...
      permissionLevel: {
        full: "Read + Reply + Send",
        reply: "Read + Reply",
        read_only: "Read only",
      },
      activityType: {
        claimed: "claimed this message",
        status_changed: "changed status to {{status}}",
        transferred: "transferred to {{name}}",
    ...
    approval: {
      ...
      returnReasonPlaceholder: "Reason for return (mock)",
      withdraw: "Withdraw submission",
      editAndSend: "Edit and send",
      adminEdited: "Admin modified content",
      viewOriginal: "View original version",
      submittedByLabel: "Submitted by {{name}}",
      recipientCrmWarning: "This recipient is linked to another CRM customer",
      matchedCrmCustomer: "Matched CRM customer",
      currentOwner: "Current owner: {{name}}",
    },
    approvalCenter: {
      title: "Mail approvals",
      open: "Open Mail approvals",
      pendingBadge: "{{count}} pending approvals",
      pendingTab: "Pending my review",
      historyTab: "Approval history",
      historyCount: "{{count}} reviewed approval(s)",
      historyEmpty: "No approval history",
      filterAll: "All",
      ...
      rejectionReasonUnavailable: "No rejection reason recorded",
      result: {
        pending: "Pending",
        approved: "Approved",
        rejected: "Rejected",
    ...
    outbox: {
      title: "Outbox",
      empty: "No messages are waiting in Outbox",
      attachments: "{{count}} attachments",
      waiting: "Waiting to send",
      sending: "Sending…",
      failed: "Send failed",
      uncertain: "Send status: manual confirmation required",
      manualConfirmation: "Send status: manual confirmation required",
      uncertainHint:
        "Do not send again. Provider acceptance cannot currently be confirmed.",
      viewDetails: "View details",
      sendOperationId: "Send operation ID",
      attemptTime: "Attempt time",
      providerMessageId: "Provider message ID",
      createdAt: "Created",
      completedAt: "Completed",
      largeAttachment: "Large Attachment involved",
      capabilityState: "Download capability state",
      lastTransportError: "Last transport error",
      markManual: "Mark for manual handling",
      revokeCapability: "Revoke attachment download access",
      confirmRevoke:
        "Revoke the Large Attachment download access for this message?",
    },
    autoReply: {
      enabled: "Auto-reply: On",
      disabled: "Auto-reply: Off",
    ...
    prototype: {
      ...
      scenarioAdmin: "Admin",
      scenarioStaffSingle: "Staff — single mailbox",
      scenarioStaffMultiple: "Staff — multiple mailboxes",
      scenarioStaffB: "Staff B — single mailbox",
      scenarioNoAccess: "Staff — mail not enabled",
      scenarioShared: "Shared mailbox",
    },
  },
  systemStatus: {
  ...
  customers: {
    ...
    familyAndContacts: "Family & Contacts",
    ...
    familyRelationshipHelper:
      "For family members only. Manage friends, colleagues, and others as separate customers.",
    familySearchLabel: "Search existing customer",
    familySearchPlaceholder: "Search name, customer code, or contact",
    familySearchModeLabel: "Search method",
    familySearchModeBroad: "General search",
    familySearchModeCustomerCode: "Exact customer code",
    familySearchModePhone: "Exact phone number",
    familySearchModeWechat: "Exact WeChat ID",
    ...
    familyApprovalReviewCopy:
      "This customer is managed by another owner. An admin will confirm the family link after submission.",
    ...
    reclaimCountdownDays: "Auto-release in {{days}} days",
    reclaimCountdownTomorrow: "Auto-release tomorrow",
    reclaimCountdownDue: "Pending release to public pool",
    reclaimCountdownGrace: "Rule-change protection",
    reclaimCountdownGraceHours: "About {{hours}} hours of protection remaining",
    reclaimCountdownTooltipLastValid: "Last valid follow-up: {{date}}",
    reclaimCountdownTooltipExpected: "Expected auto-release: {{date}}",
    reclaimCountdownTooltipRule: "Current auto-release rule: {{days}} days",
    reclaimCountdownTooltipGrace:
      "This customer is in a 24-hour protection window after an auto-release rule change.\nProtection ends: {{dateTime}}",
    masked: "Masked",
    fullData: "Full",
    ...
    moreCustomerData: "More client details",
    moreCustomerDataSubtitle: "Optional · Add more client profile details",
    moreCustomerDataExpand: "Expand more client details",
    moreCustomerDataCollapse: "Collapse more client details",
    ...
    targetCountryOrRegion: "Target country / region",
    targetCountryOrRegionPlaceholder: "Enter target country or region",
    primaryConcern: "Main concern / barrier",
    ...
    confirmRequestedProjectName: "Requested Service",
    ...
    paidServiceItems: "Paid Service Items",
    paidServiceItemsPlaceholder: "Enter paid service items",
    ...
    phase2: {
      ...
      category: {
        ...
        CUSTOMER_INITIATIVE: "Customer initiative",
        ...
        RECORD_RELIABILITY: "Record reliability",
      },
      positiveFactors: "Positive factors",
      limitingFactors: "Factors limiting progress",
      painPointsTitle: "Potential customer concerns",
      severity: {
        low: "Low",
        medium: "Medium",
        high: "High",
      ...
      painPoint: {
        ...
        REMOTE_PROCESS_CONCERN: "Remote process concern",
        TIMELINE_CONCERN: "Timeline concern",
        DOCUMENT_PREPARATION_DIFFICULTY: "Document preparation difficulty",
        FAMILY_ALIGNMENT_CONCERN: "Family alignment concern",
        TRUST_CONCERN: "Trust concern",
        REVIEW_RESULT_MISUNDERSTANDING: "Review result misunderstanding",
        PROCESS_UNCERTAINTY: "Process uncertainty",
      ...
      customerBehaviorRisks: "Customer interaction risks",
      crmProcessRisks: "Follow-up process risks",
      ...
      customerField: {
        requested_project_name: "Requested project",
        sales_stage: "Sales stage",
        source: "Source",
        next_follow_up_at: "Next follow-up time",
        last_follow_up_at: "Last follow-up time",
        last_valid_follow_up_at: "Last valid follow-up",
    ...
    aiInsightFeedback: {
      ...
      reasonTags: {
        inaccurate_intent: "Inaccurate intent assessment",
        next_action_too_generic: "Next-step advice too generic",
        robotic_message: "Message sounds too robotic",
        missed_customer_pain_point: "Missed customer pain points",
        too_long: "Analysis too long",
        too_short: "Analysis too short",
        other: "Other",
      },
    },
    aiInsightComponentFeedback: {
      prompt: "Was this section helpful?",
      helpful: "Helpful",
      notHelpful: "Not helpful",
      saved: "Saved",
      updated: "Updated",
      saving: "Saving…",
      optionalReasons: "Optional reasons",
      saveReasons: "Save reasons",
      reasonsUnsaved: "Reasons not saved yet",
      ...
      reloadAnalysis: "Reload analysis",
      retry: "Retry",
      tags: {
        base_deep: {
          accurate_summary: "Accurate summary",
          clear_next_step: "Clear next step",
          useful_risk_identification: "Useful risk identification",
          saves_time: "Saves time",
          inaccurate: "Inaccurate",
          too_generic: "Too generic",
          missed_key_information: "Missed key information",
          unsupported_inference: "Unsupported inference",
          next_step_not_useful: "Next step not useful",
          outdated_context: "Outdated context",
        },
        phase2: {
          score_reasonable: "Score looks reasonable",
          pain_points_useful: "Pain points useful",
          risk_analysis_useful: "Risk analysis useful",
          recommendation_actionable: "Recommendation actionable",
          evidence_helpful: "Evidence helpful",
          score_unreasonable: "Score unreasonable",
          missing_evidence: "Missing evidence",
          evidence_not_relevant: "Evidence not relevant",
          pain_point_inaccurate: "Pain point inaccurate",
          risk_inaccurate: "Risk inaccurate",
          recommendation_not_actionable: "Recommendation not actionable",
          insufficient_data: "Insufficient data",
        },
        suggested_message: {
          ready_to_send: "Ready to send",
          natural_tone: "Natural tone",
          useful_starting_point: "Useful starting point",
          matches_customer_context: "Matches customer context",
          sounds_robotic: "Sounds robotic",
          too_long: "Too long",
          too_pushy: "Too pushy",
          inaccurate_details: "Inaccurate details",
          unsuitable_tone: "Unsuitable tone",
          requires_major_edit: "Requires major edit",
        },
      },
    },
    approvalTypes: {
  ...
  completenessFields: {
    ...
    job_title: "Job title",
    target_country_or_region: "Target country / region",
    primary_concern: "Main concern / barrier",
  },
  ...
  notifications: {
    ...
    viewAll: "View All",
    enterCenter: "Open Action Center →",
  ...
  workItems: {
    title: "Action Center",
    subtitle:
      "Review tasks that need attention and system notifications in one place.",
    rolesHint:
      "Tasks are work to complete. Notifications are status updates and system messages.",
    tabTasks: "Tasks",
    ...
    customerUnavailable: "Related client unavailable",
    taskTypeFollowUp: "Customer follow-up",
    taskTypeFirstContact: "First contact",
    taskTypeOther: "Other",
    taskTitleFollowUpPrefix: "Follow up: ",
    taskTitleFirstContactPrefix: "First contact: ",
    ...
    loading: "Loading…",
    loadTasksFailed: "Unable to load tasks",
  ...
  dashboard: {
    ...
    dueTodayFollowUps: "Due today",
    autoReleaseWithin7Days: "Auto-release within 7 days",
    autoReleaseTomorrow: "Auto-release tomorrow",
    autoReleaseWithin14Days: "Auto-release within 8–14 days",
    pendingWorkItems: "Pending items",
    validFollowUpsToday: "Valid follow-ups today",
    newCustomersToday: "New customers today",
    publicPoolEnteredToday: "Entered public pool today",
    customerReclamationRisk: "Customer release risk",
    teamCustomerReclamationRisk: "Team customer release risk",
    viewRelatedCustomers: "View related customers",
    noReclamationRisk: "No customers are currently nearing auto-release",
    todayManagementPriorities: "Today's management priorities",
    todayPriorities: "Today's priorities",
    myClientsOverview: "My customers overview",
    clientsOverview: "Customers overview",
    pendingReclamationCustomers: "Pending reclamation customers",
    reclamationMembersInvolved: "Team members involved",
    staffWelcomeDueToday: "You have {{count}} customers to follow up today",
    viewWorkItems: "View work items",
    recentNotifications: "Recent notifications",
    latestAnnouncements: "Latest announcements",
    trendOverview: "Trend overview",
    trendLast7Days: "Last 7 days",
    trendLast30Days: "Last 30 days",
    trendLast90Days: "Last 90 days",
    trendRange7: "7 days",
    trendRange30: "30 days",
    trendRange90: "90 days",
    trendMetricLabel: "Metric",
    trendMetricValidFollowUps: "Valid follow-ups",
    trendMetricNewCustomers: "New customers",
    trendMetricEnteredNegotiation: "Entered negotiation",
    trendMetricClosedWon: "Closed Won",
    trendMetricReleasedToPool: "Released to public pool",
    ...
    stageDistributionTitle: "Customer stage distribution",
    ...
    sourceDistributionOther: "Other sources",
    sourceDistributionCenterLabel: "Customers",
    sourceDistributionTapHint: "Tap the chart to view source details",
    sourceDistributionViewDetails: "View source details",
    sourceDistributionResetSelection: "Reset chart selection",
    ...
    teamExecutionLast30Days: "Last 30 days",
    teamExecutionLast90Days: "Last 90 days",
    teamExecutionPeriodActivity: "Period activity",
    teamExecutionCurrentStatus: "Current status",
    teamExecutionMember: "Team member",
    teamExecutionCurrentCustomers: "Current customers",
    teamExecutionValidFollowUps: "Valid follow-ups",
    teamExecutionStageProgress: "Customers with stage progress",
    teamExecutionOverdue: "Overdue follow-ups",
    teamExecutionAutoRelease7d: "Auto-release within 7 days",
    teamExecutionPendingItems: "Pending items",
    teamExecutionEmpty: "No team member data is currently available",
    teamExecutionUnavailable: "Team execution data is temporarily unavailable",
    teamExecutionViewCustomers: "View customers",
    aiTodaySuggestions: "AI Today Suggestions",
    aiManagementBrief: "AI Management Brief",
    aiSourceProvider: "AI generated",
    aiSourceSystemFallback: "Based on system data",
    aiSourceMock: "Mock AI data",
    aiRefresh: "Refresh",
    aiRefreshing: "Refreshing…",
    aiGeneratingSuggestions: "Generating suggestions",
    aiGeneratingBrief: "Generating management brief",
    aiUnavailable: "AI service is temporarily unavailable",
    aiTimeout: "AI response timed out. Please try again later",
    aiInvalidResponse: "AI response is temporarily unusable",
    aiDisabled: "AI is currently disabled",
    aiRateLimited: "Please try refreshing again shortly",
    aiViewCustomer: "View customer",
    aiGoToItem: "Go to item",
    aiGoToSettings: "Open AI settings",
    aiManagementPriorities: "Management priorities",
    aiCautions: "Cautions",
    aiNoActions: "No suggestions right now",
    aiUrgency: {
      normal: "Normal",
      attention: "Attention",
      urgent: "Urgent",
  ...
  knowledge: {
    ...
    accessUninitializedNotice:
      "Knowledge has not been initialized yet. Contact a CRM administrator to complete the first-time setup.",
    ...
    errors: {
      ...
      notInitialized: "Knowledge has not been initialized.",
      alreadyInitialized: "Knowledge has already been initialized.",
      accessRequired: "Complete Knowledge verification before continuing.",
      roleRequired: "You do not have the required Knowledge permission.",
      adminRequired: "CRM administrator permission is required.",
      passwordRequired: "Enter the Knowledge password.",
      passwordMismatch: "The Knowledge passwords do not match.",
      passwordInvalid: "Incorrect password.",
      passwordLocked: "Too many attempts. Please try again later.",
      passwordNotConfigured: "Knowledge password has not been configured.",
      lastAdmin: "At least one Knowledge administrator must remain.",
      roleInvalid: "The Knowledge role is invalid.",
      categoryInvalid: "Category information is invalid.",
      categoryNotFound: "The category could not be found.",
      categoryHasArticles:
        "Categories with articles cannot be deleted. Deactivate instead.",
      categoryDeleteDisabled: "Permanent category deletion is not supported.",
      articleInvalid: "Article information is invalid.",
      articleNotFound: "The requested article could not be found.",
      articleAccessDenied: "You do not have access to this article.",
      articleConflict:
        "The article has changed. Reload and try again.",
      articleNotEditable: "This article cannot be edited in its current state.",
      sourceInvalid: "Source information is invalid.",
      sourceNotFound: "The source could not be found.",
      sourceAccessDenied: "You do not have access to this source.",
      ...
      reviewNotFound: "The review record could not be found.",
      reviewAccessDenied: "You do not have access to this review record.",
      reviewConflict: "This review is no longer in the expected state.",
      reviewNoteRequired: "Enter a meaningful review note.",
      reviewSelfApproval: "You cannot review your own submission.",
      reviewArchived: "Archived articles cannot be submitted for review.",
      reviewAssignmentInvalid: "The reviewer assignment is invalid.",
      searchInvalid: "Search query is invalid.",
      aiRateLimited: "Knowledge AI daily limit reached. Please try again later.",
      aiBusy: "A Knowledge AI request is already in progress.",
      aiTimeout: "Knowledge AI timed out. Please try again later.",
      aiProviderFailed: "Knowledge AI is temporarily unavailable.",
      aiQaOutputInvalid: "Knowledge AI returned an invalid answer.",
      aiNoSources:
        "Published Knowledge does not contain enough information to answer.",
      aiCitationInvalid: "Knowledge AI returned invalid citations.",
      reprocessConfirmationRequired: "Confirm that you want to replace the completed source reading before trying again.",
      aiComparisonRequired: "Compare this topic before saving it as a draft.",
      aiComparisonStale: "This comparison is out of date. Refresh and compare again before saving.",
      candidateReanalysisBlocked: "This source has changed or a topic has already been saved as a draft. Refresh to check its state; sources with saved topic drafts cannot be analyzed again.",
      analysisEmptySource: "This source has no text to analyze. Add source text first.",
      analysisUnsupportedSourceType: "Analysis currently supports pasted text only.",
      analysisAlreadyRunning: "This source is already being analyzed. Wait for it to finish.",
      analysisSegmentationFailed: "The source could not be split into topics. Please try analyzing it again.",
      analysisRunNotFound: "This analysis could not be found. Refresh and try again.",
      analysisSegmentNotFound: "This topic is unavailable or out of date. Refresh the source and try again.",
    },
    placeholderTitle: "Business Knowledge",
    placeholderDescription: "The Knowledge foundation module is enabled.",
    lock: "Lock Knowledge",
    home: {
      pageDescription: "Business Knowledge",
      browseHint:
        "Browse internal business materials by category. Articles are available only within your Knowledge permissions.",
      confidentialityNotice:
        "Confidentiality Notice: Content in this area is for authorized internal use only. Do not disclose, forward, or use it externally without authorization.",
      newDraft: "New Draft",
      ingest: "Source ingest",
      myReviews: "My reviews",
      reviewCenter: "Review Center",
      lockKnowledge: "Lock Knowledge",
      categories: "Categories",
      allArticles: "All articles",
      manageCategories: "Manage categories",
      manageCategoriesLink: "Manage",
      articlesHeading: "Articles",
      noArticlesYet: "No articles yet",
      createFirstDraft: "Create first draft",
      categoryName: "Category name",
      categoryDescription: "Short description (optional)",
      addCategory: "Add category",
      createCategoryFailed: "Failed to create category",
      deactivateCategory: "Deactivate category",
      inactiveSuffix: " · inactive",
      articleCount: "{{count}} articles",
      articleCountFiltered: "{{count}} articles (current category)",
      ...
      quickViewDialogLabel: "Article quick view",
      statusDraft: "Draft",
      statusArchived: "Archived",
      statusPublished: "Published",
    },
    labels: {
      reviewerQueue: "Unassigned · Reviewer queue",
      reviewStatus: {
    ...
    article: {
      newTitle: "New Knowledge draft",
      newDescription:
        "Create a plain-text article draft. After saving, you can submit it for review.",
      editTitle: "Edit Knowledge draft",
      editDescription:
        "Saving creates an immutable article version snapshot.",
      ...
      metaDescription: "{{category}} · Updated {{date}}",
      versionBadge: "Version {{version}}",
      publishedVersionBadge: "Published Version {{version}}",
      publicationHistory: "Publication history",
      noEditPermission: "You do not have permission to edit Knowledge articles.",
      titleLabel: "Title",
      ...
      bodyLabel: "Body",
      bodyHint:
        "Use plain text only. Avoid scripts, iframes, or unsafe HTML.",
      changeNoteLabel: "Change note (optional)",
      selectCategory: "Select a category",
      visibilityTeam: "Team",
      visibilityOwner: "Owner (self and Admin only)",
      visibilityRestricted: "Restricted (Admin only for now)",
      ...
      confirmArchiveMessage:
        "Archive this article? Archived articles can no longer be edited.",
      archiveFailed: "Failed to archive article",
      changesRequestedTitle: "Changes requested",
      submittedVersionLine: "Submitted Version {{version}}",
      editRevision: "Edit revision",
      inReviewTitle: "In review · Version {{version}}",
      withdrawFirstHint: "Withdraw the review before making changes.",
      publishedTitle: "Published · Version {{version}}",
      publishedWithDraftLine:
        "Published Version {{published}} · Current draft Version {{current}} · Unpublished changes",
      resubmitReview: "Resubmit for review",
      submitReview: "Submit for review",
      submitCurrentVersion: "Submit current Version {{version}} for review",
      submissionNotePlaceholder: "Submission note (optional)",
      submitting: "Submitting…",
      confirmSubmitReview: "Confirm submission",
      inReviewActive:
        "This version is under review (Version {{version}}). Withdraw the review before editing.",
      withdrawReview: "Withdraw review",
      submitReviewFailed: "Failed to submit for review",
      withdrawReviewFailed: "Failed to withdraw review",
      historyTitle: "Version history · {{title}}",
      historyDescription:
        "Historical versions are read-only. One-click restore is not supported yet.",
      versionsHeading: "Versions",
      currentBadge: "Current",
      currentlyPublishedBadge: "Currently published",
      previouslyPublishedBadge: "Previously published",
      selectVersionPrompt: "Select a historical version to view.",
      ingestChangeNote: "Created from AI organization after human review",
    },
    ingest: {
      pageTitle: "Ingest internal source",
      description: "Paste text or upload one business document for human-reviewed organization.",
      notice:
        "Internal business use only. Do not upload customer names, phone numbers, personal email addresses, home addresses, identity documents, bank information, statements, contracts containing personal data, customer applications, CRM exports, or customer lists.",
      pasteTab: "Paste text",
      fileTab: "Upload file",
      ...
      getTestFixtures: "Get test files",
      ...
      analysisPasteOnly: "Smart analysis is only available for pasted text sources",
      segmentKeep: "Keep",
      segmentKept: "Kept ✓",
      segmentReject: "Reject",
      segmentRejected: "Rejected",
      segmentConfirmAll: "Keep all",
      segmentReviewTopicsDetected: "{{count}} topics identified",
      segmentReviewConfirmedCount: "{{count}} kept",
      segmentReviewUnconfirmedCount: "{{count}} unconfirmed",
      segmentReviewRejectedCount: "{{count}} rejected",
      segmentExcerpt: "Excerpt",
      segmentViewFull: "View full excerpt",
      segmentCollapse: "Collapse",
      segmentNumber: "Topic {{index}}",
      creatingSource: "Creating source…",
      creatingSourceBusy: "Creating…",
      sourceCreatedSuccess: "Raw source created",
      sourceEstablished: "Source created",
      ...
      smartIngestStepConfirmTopics: "Confirm topics",
      smartIngestStepOrganize: "Organize independently",
      smartIngestStepCompare: "Knowledge compare",
      smartIngestStepSaveDrafts: "Save drafts",
      smartIngestCandidateCompare: "Compare knowledge",
      smartIngestCandidateCompareAgain: "Compare again",
      smartIngestCandidateComparing: "Comparing…",
      smartIngestCandidateCompareDone: "Compare completed",
      smartIngestCandidateCompareStale: "Re-compare required",
      smartIngestCandidateCompareAwaitOrganize: "Complete independent organize first",
      smartIngestCandidateCompareFailed: "Knowledge compare failed. Please try again.",
      smartIngestCandidateCompareRequired: "Complete knowledge compare first",
      smartIngestCandidateSaveDraft: "Save as draft",
      ...
      smartIngestCandidateWorkflowProgress:
        "Organized {{organized}}/{{total}} · Compared {{compared}}/{{total}} · Saved {{saved}}/{{total}}",
      smartIngestCandidateAllSaved: "All kept topics are saved as separate drafts",
    ...
    previewFixtures: {
      ...
      localOnlyNotice:
        "LOCAL PREVIEW ONLY · synthetic test files · not available in production",
      download: "Download",
      backToIngest: "Back to Knowledge ingest",
      simpleDocx: "Simple DOCX",
      simpleDocxDescription: "Single-paragraph synthetic DOCX for mobile upload testing.",
      tableDocx: "DOCX with table",
      tableDocxDescription: "Paragraph plus table cells for extraction verification.",
      textPdf: "Text PDF",
      textPdfDescription: "Text-based PDF with a selectable text layer.",
      scannedPdf: "Scanned PDF",
      scannedPdfDescription:
        "Image-only PDF with no text layer; should show unsupported extraction.",
    ...
    review: {
      ...
      description: "Review immutable article versions before publication.",
      centerDescription:
        "Review fixed article versions and publication history. Article editing is not available in the review center.",
      pending: "Pending review",
      mine: "Submitted by me",
      history: "History",
      ...
      confirmPublish: "Confirm publish Version {{version}}?",
      published: "Published",
      unpublishedChanges: "Unpublished changes",
      exactVersion: "Reviewing Version {{version}}",
      loadListFailed: "Failed to load review list",
      loadDetailFailed: "Failed to load review record",
      actionFailed: "Review action failed",
      emptyList: "No review records yet.",
      emptySelection: "Select a review record to view the fixed version content.",
      ...
      unassignedQueueHint:
        "Requests without an assigned reviewer enter the pending queue for available reviewers.",
      submissionNoteLabel: "Submission note: {{note}}",
      summaryLabel: "Summary: {{summary}}",
      reviewNoteLabel: "Review note: {{note}}",
      assignReviewer: "Assign reviewer",
      selectOption: "Select",
      assignReview: "Assign review",
      changesNoteLabel: "Changes requested note",
      confirmPublishPrompt:
        "Confirm publish \"{{title}}\" Version {{version}}? Visibility: {{visibility}}",
      confirmApprovePublish: "Confirm approve and publish",
      cancel: "Cancel",
      dueOverdue: "Overdue",
      dueSoon: "Due soon",
      dueNormal: "On track",
    ...
    members: {
      ...
      youBadge: "You",
      knowledgeAdminBadge: "Knowledge Administrator",
      lastAdminReadonly: "Only administrator — cannot remove",
      soleAdminProtected: "Sole administrator — role protected",
      roleChooserTitle: "Member role",
      searchPlaceholder: "Search members",
      filterAll: "All",
      filterUnassigned: "Unassigned",
      pendingCount: "{{count}} members changed",
      cancelChanges: "Cancel",
      loadFailed: "Failed to load members",
      updateFailed: "Failed to update role",
      lastAdminError: "At least one Knowledge administrator must remain.",
    ...
    categories: {
      ...
      description: "Create and manage Knowledge categories",
      backToKnowledge: "Back to Knowledge",
      tabCategories: "Knowledge categories",
      tabBusinessMapping: "Business Mapping",
      businessMappingTitle: "Business Mapping",
      businessMappingDescription:
        "Set the default Knowledge category for each CRM related business. Ingest can still use a different category when needed.",
      businessMappingSearch: "Search related businesses",
      businessMappingCrmBusiness: "CRM related business",
      businessMappingDefaultCategory: "Default Knowledge category",
      businessMappingNotSet: "Not set",
      businessMappingStatusMapped: "Mapped",
      businessMappingStatusUnmapped: "Not set",
      businessMappingStatusCategoryInactive: "Category inactive",
      businessMappingStatusMappingInactive: "Mapping inactive",
      businessMappingSave: "Save mapping",
      businessMappingSaving: "Saving…",
      businessMappingSaved: "Mapping saved",
      businessMappingDeactivate: "Deactivate mapping",
      businessMappingDeactivating: "Deactivating…",
      businessMappingDeactivated: "Mapping deactivated",
      businessMappingSelectCategory: "Select Knowledge category",
      businessMappingLoadFailed: "Could not load business mappings",
      businessMappingSaveFailed: "Could not save mapping",
    },
    searchAi: {
      ...
      insufficientAnswer:
        "This answer reflects published Knowledge only; available material may be insufficient.",
  ...
  publicPool: {
    ...
    previousOwnerUnknown: "Unknown member",
    actions: "Actions",
    claiming: "Claiming…",
    claim: "Claim",
    masked: "Masked",
    ...
    randomClaimCooldownHint: "You can claim again after the cooldown ends",
    ...
    quickEntry: {
      entryTitle: "Quick Customer Entry",
      entryDescription:
        "Enter one or more new customers directly into the public pool.",
      openButton: "Open quick entry",
      panelTitle: "Quick customer entry",
      panelDescription: "Add customers directly to the public pool.",
      close: "Close",
      cancel: "Cancel",
      loading: "Loading quick entry…",
      modeSingle: "Single entry",
      modeBatch: "Batch entry",
      saveContinue: "Save and continue",
      saveDone: "Finish entry",
      keepProject: "Keep requested project when continuing",
      addNote: "+ Add supplemental note",
      collapseNote: "Collapse supplemental note",
      projectSearchPlaceholder: "Search or select a project",
      projectOtherHint:
        "You selected Other — enter a custom project (at least 4 characters).",
      projectOtherOption: "Other",
      discardTitle: "Discard this entry?",
      discardDescription: "Unsaved changes will be lost.",
      discardConfirm: "Discard",
      discardCancel: "Keep editing",
      closeBlockedHint: "Please wait until submission finishes.",
      toastContinueSuccess: "Customer created. Ready for the next one.",
      sessionCreatedCount: "Created this session: {{count}}",
      ...
      resultDuplicateHeading: "Duplicate found",
      resultInvalidTitle: "Details need changes",
      resultFailedTitle: "Could not create customer",
      resultBackEdit: "Back to edit",
      batchAddedCount: "{{count}} customers added",
      batchExpandAll: "Expand all",
      batchCollapseAll: "Collapse all",
      batchAddCustomer: "Add customer",
      batchSubmitCount: "Submit {{count}} customers",
      batchNeedsFix: "{{count}} customers need changes",
      batchCardLabel: "Customer {{n}}",
      batchEmptyName: "Name not filled",
      batchEmptyContact: "Contact not filled",
      batchEmptyProject: "Project not filled",
      batchExpand: "Expand",
      batchCollapse: "Collapse",
      batchDeleteAria: "Delete customer {{n}}",
      batchDeleteConfirmTitle: "Delete this customer?",
      batchDeleteConfirmDescription:
        "Filled details for this card will be discarded.",
      batchDeleteConfirm: "Delete",
      batchDeleteCancel: "Keep",
      cardBadge: {
      ...
      resultViewDetails: "View details",
      resultHideDetails: "Hide details",
      resultAddedToPool: "Added to the public pool",
      returnIncomplete: "Edit uncreated customers",
      modeSwitchTitle: "Switch entry mode?",
      modeSwitchSingleToBatch:
        "Keep the current customer as the first batch card, or discard and start a blank batch?",
      modeSwitchBatchMultiToSingle:
        "Single entry can keep only one customer. Other cards will be discarded if you continue.",
      modeSwitchKeepAsBatchFirst: "Keep and convert to batch",
      modeSwitchKeepFirst: "Keep the first customer",
      modeSwitchDiscardAll: "Discard all",
      modeSwitchCancel: "Cancel",
      featureDisabled: "Quick entry is currently disabled by an administrator.",
      featureDisabledSubtle:
        "Quick customer entry is unavailable while the feature is disabled.",
      verifyHint: "Enter the quick-entry code to continue.",
      verifyCodeLabel: "Quick-entry code",
      verifyCodeRequired: "Enter the quick-entry code.",
      verifySubmit: "Verify",
      verifying: "Verifying…",
      lockedMessage:
      ...
      fields: {
        ...
        supplementalNote: "Supplemental note",
      },
      rowLabel: "Row {{n}}",
      addRow: "Add row (max {{max}})",
      ...
      replayNotice: "Restored the previous submission result.",
      processingMessage:
        "This batch is still processing. Please retry in about {{seconds}} seconds. Your submission ID is kept.",
      idempotencyConflict:
        "This batch content changed and cannot reuse the same submission ID. Start a new batch.",
  ...
  settings: {
    ...
    publicPoolQuickEntry: {
      ...
      resetCode: "Reset entry code",
      setCodeTitle: "Set quick-entry code",
      resetCodeTitle: "Reset quick-entry code",
      newCode: "New entry code",
      confirmCode: "Confirm entry code",
      codeRules:
        "8–64 characters, at least one letter and one number, no leading or trailing spaces.",
      saveCode: "Save code",
      cancel: "Cancel",
      codeStatusLabel: "Entry code",
      codeConfigured: "Configured",
      codeNotConfigured: "Not configured",
      updatedAtLabel: "Last updated",
      updatedAtNone: "Never",
      updatedByLabel: "Updated by",
      updatedByNone: "—",
      needCodeBeforeEnable: "Set an entry code before enabling this feature.",
      enableSuccess: "Public pool quick entry has been enabled.",
      disableSuccess: "Public pool quick entry has been disabled.",
      codeResetSuccess:
        "Entry code updated. All existing quick-entry grants are now invalid.",
      codeRequired: "Enter and confirm the entry code.",
      codeMismatch: "The two entry codes do not match.",
      codeFormat:
        "Entry code must be 8–64 characters with at least one letter and one number, and no leading or trailing spaces.",
      loadFailed: "Unable to load quick-entry settings. Please try again.",
  ...
  aiFeedbackStats: {
    ...
    reasonTagRankings: "Low-score reason rankings",
    byModel: "Stats by model",
    byPromptVersion: "Stats by prompt version",
    ...
    count: "Count",
    reasonTag: "Reason",
    noReasonTags: "No low-score reason data yet",
  },
  aiEffectStats: {
    title: "AI Effect Analytics",
    description:
      "Review usage, reliability, Phase 2 generation, and internal feedback for AI deep analysis. All results are aggregated for internal use.",
    loading: "Loading AI effect statistics…",
    updating: "Updating…",
    retry: "Reload",
    ...
    errors: {
      generic:
        "AI effect statistics could not be loaded right now. Please try again later.",
      dataLimit:
        "The selected range contains too much statistics data. Narrow your filters and try again.",
      auth: "You do not have permission to view AI effect statistics.",
      malformed:
        "AI effect statistics could not be loaded right now. Please try again later.",
    },
    filters: {
      ...
      phase2Generated: "Phase 2 generated",
      reset: "Reset filters",
      all: "All",
      feedbackTargetScopeNote:
        "This filter only affects feedback statistics. It does not change AI refresh or Phase 2 statistics.",
      providers: {
        all: "All",
    ...
    sections: {
      overview: "AI refresh overview",
      roleDistribution: "Role distribution",
      failures: "Refresh failures",
      phase2: "Phase 2 performance",
      componentFeedback: "Component feedback impact",
    },
    cards: {
      refreshAttempts: "Refresh attempts",
      baseSuccessRate: "Base success rate",
      refreshFailureRate: "Refresh failure rate",
      uniqueCustomers: "Unique customers",
      uniqueActors: "Unique actors",
      feedbackSubmitted: "Feedback submitted",
      baseSuccessHint:
        "Safe degradation still counts as a successful base deep analysis.",
      refreshFailureHint:
        "Refresh failure is not the same as provider failure.",
    },
    roles: {
    ...
    failures: {
      ...
      nonProvider: "Non-provider failure",
      unknown: "Unknown failure stage",
      providerHint:
        "Provider failure: confirmed during the provider HTTP stage.",
      unknownHint:
        "Unknown: legacy events or incomplete data; no inference was made.",
    },
    phase2: {
      eligibleReady: "Eligible ready",
      generated: "Generated",
      safeDegraded: "Safe degraded",
      unknownOutcome: "Unknown outcome",
      generationRate: "Phase 2 generation rate",
      safeDegradationRate: "Safe degradation rate",
      ineligibleReady: "Ineligible ready",
      unknownEligibility: "Unknown eligibility",
      eligibilitySecondary: "Eligibility details",
      degradationReasons: "Safe degradation reasons",
      noDegradationReasons: "No safe degradation reason data yet.",
      safeDegradationDescription:
        "Safe degradation means base deep analysis succeeded, but Phase 2 was not generated.",
    },
    targets: {
      base_deep: "Base Deep Analysis",
      phase2: "Phase 2",
    ...
    feedback: {
      topHelpfulReasons: "Top helpful reasons",
      topNotHelpfulReasons: "Top not helpful reasons",
      noTags: "No tag data yet.",
    },
    coverage: {
      title: "Feedback coverage",
      unavailable: "Feedback coverage is currently unavailable",
      explanation:
        "The system does not record which analysis sections each user actually saw, so coverage is not estimated from feedback count divided by analysis count.",
      submittedFeedback: "Submitted feedback",
      uniqueFeedbackActors: "Unique feedback actors",
      uniqueFeedbackGenerations: "Unique feedback generations",
    },
    legacy: {
      title: "Legacy overall ratings",
      submitted: "Submitted",
      averageRating: "Average rating",
      helpful: "Helpful",
      neutral: "Neutral",
    ...
    dataQuality: {
      title: "Data quality",
      notice:
        "Some legacy data is missing complete statistics dimensions. The system classified those rows as unknown and did not infer values.",
      ok: "Data quality looks normal.",
      fields: {
        legacyRefreshEvents: "Legacy refresh events",
        unknownProviderEvents: "Unknown provider",
        unknownContractEvents: "Unknown contract",
        unknownActorRoleEvents: "Unknown actor role",
        unknownPhase2OutcomeEvents: "Unknown Phase 2 outcome",
        invalidTagRows: "Invalid tag rows",
        malformedAuditMetadataEvents: "Malformed audit metadata",
      },
    },
    table: {
      role: "Role",
    ...
    degradationReasons: {
      missing_signals: "Missing signals",
      invalid_signal_schema: "Invalid signal schema",
      forbidden_score_injection: "Forbidden score injection",
      invalid_evidence: "Invalid evidence",
      fact_safety_rejected: "Fact safety rejected",
      local_composition_failed: "Local composition failed",
  ...
  errors: {
    ...
    invalidAgeRange: "Invalid age range option.",
    invalidPreferredLanguage: "Invalid preferred language option.",
    invalidPreferredContactMethod: "Invalid preferred contact method option.",
    preferredNameTooLong: "Preferred name must be at most 40 characters.",
    occupationTooLong: "Occupation must be at most 60 characters.",
    companyNameTooLong: "Company name must be at most 120 characters.",
    jobTitleTooLong: "Job title must be at most 80 characters.",
    targetCountryOrRegionTooLong:
      "Target country / region must be at most 80 characters.",
    primaryConcernTooLong: "Main concern must be at most 200 characters.",
