...
const zhHans: Messages = {
  ...
  customers: {
    ...
    phase2: {
      ...
      opportunityDisclaimer: "此评分仅供员工判断下一步，不代表客户一定成交。",
  ...
  aiEffectStats: {
    title: "AI 效果统计",
    description:
      "查看 AI 深度分析的使用、稳定性、Phase 2 生成情况及员工反馈。所有数据均为内部聚合统计。",
  ...
  aiSettings: {
    ...
    statusDisabled: "已关闭",
    noStaff: "目前没有启用中的员工账户",
    staffListTruncated:
      "仅显示前 {{limit}} 位启用员工。上方总计仍涵盖全体员工。",
    staffUsageLoadFailed: "无法加载员工 AI 使用统计",
    save: "保存设置",
    saving: "保存中…",
