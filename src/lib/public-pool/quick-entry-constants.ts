...
export const QUICK_ENTRY_ERROR_CODES = {
  ...
  GRANT_REQUIRED: "QUICK_ENTRY_GRANT_REQUIRED",
  GRANT_EXPIRED: "QUICK_ENTRY_GRANT_EXPIRED",
  GRANT_VERSION_MISMATCH: "QUICK_ENTRY_GRANT_VERSION_MISMATCH",
  REQUEST_TOO_LARGE: "QUICK_ENTRY_REQUEST_TOO_LARGE",
  UNSUPPORTED_MEDIA_TYPE: "QUICK_ENTRY_UNSUPPORTED_MEDIA_TYPE",
  VALIDATION_ERROR: "VALIDATION_ERROR",
} as const;

/** Max raw request body size for quick-entry batch API (bytes). */
export const QUICK_ENTRY_MAX_BODY_BYTES = 65536;
