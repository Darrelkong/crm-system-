...
export type KnowledgeAuditAction =
  ...
  | "knowledge_source_analysis_started"
  | "knowledge_source_segment_reviewed"
  ...
  | "knowledge_comparison_started"
  | "knowledge_comparison_completed"
  | "knowledge_comparison_failed"
