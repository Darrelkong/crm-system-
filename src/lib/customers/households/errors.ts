export const FAMILY_ERROR_CODES = {
  ...
  INVALID_SEARCH_PARAMS: "FAMILY_INVALID_SEARCH_PARAMS",
  TARGET_NOT_IN_HOUSEHOLD: "FAMILY_TARGET_NOT_IN_HOUSEHOLD",
  APPROVAL_STALE: "FAMILY_APPROVAL_STALE",
  COMPANY_MEMBER_EDIT_FORBIDDEN: "FAMILY_COMPANY_MEMBER_EDIT_FORBIDDEN",
  MANAGEMENT_USE_DEDICATED_ENDPOINT: "FAMILY_MANAGEMENT_USE_DEDICATED_ENDPOINT",
} as const;
