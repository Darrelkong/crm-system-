-- TASK 14-B6-PRE: add update_family_relationship and unlink_family_customer approval types
-- Rebuild approvals request_type CHECK constraint to include family management types
